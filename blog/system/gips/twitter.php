...
class E2GIPTwitter extends E2GIP {
  ...
  public function get_auth_url() {
    ...
    if(is_null($proxy_url)){
        ...
        $url = $proxy_url.'?type=twitter&callback_url='.urlencode($this->get_callback_url());        
    }
    return $url;
  }
  ...
  public function callback() {
    if(isset($_GET['data'])){
        ...
        $this->save_session($user->screen_name, $user->name, $access_token['oauth_token'], $avatar_name);
    }  
