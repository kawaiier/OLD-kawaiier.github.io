...
<div class="form-control">
  ...
  <div class="e2-comment-form-meta-area">
    <span class="e2-comment-piece-markable <?php if (@$comment['important?']) echo 'e2-comment-piece-marked' ?>"><?php if ($comment['gip-used?']) { ?><a href="<?= $comment['name-href'] ?>" class="e2-service-color-neutral nu"><span class="e2-svgi e2-svgi-smaller"><?= _SVG ($comment['gip']) ?></span> </a><?php } ?><?= @$comment['name'] ?></span>
